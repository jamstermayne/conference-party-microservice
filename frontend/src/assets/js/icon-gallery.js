/**
 * Professional Icon Gallery
 * Consistent SVG icons for the entire application
 * All icons are 24x24 viewBox with 2px stroke width for consistency
 */
...
export const IconGallery = {
  ...
  handshake: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="m17 10-2-2 3-3 2 2-3 3Z"/>
    <path d="M14 7 8.5 1.5"/>
    <path d="M10 3 8 5l4 4 2-2-4-4Z"/>
    <path d="m14 17 2 2-3 3-2-2 3-3Z"/>
    <path d="M10 21 15.5 15.5"/>
    <path d="m18 21 2-2-4-4-2 2 4 4Z"/>
  </svg>`,
  ...
  userPlus: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  wifiOff: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  chartBar: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  settings: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <path d="M12 1v6m0 6v6m4.22-13.22l4.24 4.24M1.54 9.96l4.24 4.24M3.34 14.02l-4.24 4.24M14.02 3.34l4.24-4.24M20.66 14.02l-4.24 4.24M14.02 20.66l4.24 4.24M9.96 1.54l-4.24 4.24M9.96 22.46l-4.24-4.24"/>
  </svg>`,
  ...
  bellOff: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    <path d="M13.73 21a2 2 0 0 1-3.46 0"/>
...
/**
 * Helper function to get icon HTML with optional size and class
 * @param {string} name - Icon name from the gallery
 * @param {number} size - Icon size in pixels (default: 24)
 * @param {string} className - Additional CSS classes
 * @returns {string} HTML string of the icon
 */
export function getIcon(name, size = 24, className = '') {
  const icon = IconGallery[name];
  if (!icon) {
    console.warn(`Icon "${name}" not found in gallery`);
    return '';
  }
...
/**
 * Icon component for React-like usage
 * @param {string} name - Icon name
 * @param {Object} props - Additional properties
 * @returns {HTMLElement} DOM element
 */
export function Icon(name, props = {}) {
  const { size = 24, className = '', color = 'currentColor', ...attrs } = props;
