...
const VIEWS = {
  'parties': {
    mount: '#events-list',
    loader: () => import('/js/events-controller.js?v=b023' + V).then(m => m.renderEvents)
  },
  'hotspots': {
    mount: '#hotspots-root',
    loader: () => import('/js/hotspot-controller.js?v=b023' + V).then(m => m.renderHotspots)
  },
  'map': {
    mount: '#map-root',
    loader: () => import('/js/map-controller.js?v=b023' + V).then(m => m.renderMap)
  },
  'calendar': {
    mount: '#calendar-root',
    loader: () => import('/js/calendar-view.js?v=b023' + V).then(m => m.renderCalendar)
  },
  'invites': {
    mount: '#invites-root',
    loader: () => import('/js/invite-controller.js?v=b023' + V).then(m => m.renderInvites)
  },
  'me': {
    mount: '#account-root',
    loader: () => import('/js/account.js?v=b023' + V).then(m => m.renderAccount)
  },
  'settings': {
