...
import { renderEvents } from '../ui/homeViews.js?v=b023';
import * as API from '../services/api.js?v=b023';
import * as CAL from '../services/calendar.js?v=b023';
import * as NAV from '../services/nav.js?v=b023';
...
export default class EventsControllerLegacy {
  ...
  async initializeMap() {
    ...
    try {
      ...
      const { maps } = await import('../services/maps.js?v=b023');
