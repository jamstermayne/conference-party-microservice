...
import { renderStatusCard, renderHotspots, renderEvents } from '../ui/homeViews.js?v=b011';
import { mountSignalField } from '../ui/canvasField.js?v=b011';
import * as Proximity from '../services/proximity.js?v=b011';
