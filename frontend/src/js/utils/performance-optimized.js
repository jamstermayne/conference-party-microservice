...
import domCache, { $, $$, batchDOM } from './dom-cache.js?v=b011';
import eventDelegate, { on, off, throttle, debounce } from './event-delegate.js?v=b011';
import lazyLoader, { lazyLoad, loadOnIdle, loadOnVisible } from './lazy-load.js?v=b011';
import requestCache, { cachedFetch, batchFetch, prefetch } from './request-cache.js?v=b011';
